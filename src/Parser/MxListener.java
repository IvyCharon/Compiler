...
public interface MxListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MxParser#paraDeclList}.
	 * @param ctx the parse tree
	 */
	void enterParaDeclList(MxParser.ParaDeclListContext ctx);
	/**
	 * Exit a parse tree produced by {@link MxParser#paraDeclList}.
	 * @param ctx the parse tree
	 */
	void exitParaDeclList(MxParser.ParaDeclListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link MxParser#varList}.
	 * @param ctx the parse tree
	 */
	void enterVarList(MxParser.VarListContext ctx);
	/**
	 * Exit a parse tree produced by {@link MxParser#varList}.
	 * @param ctx the parse tree
	 */
	void exitVarList(MxParser.VarListContext ctx);
	/**
